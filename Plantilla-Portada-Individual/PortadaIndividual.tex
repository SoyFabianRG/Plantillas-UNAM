...
\begin{titlepage}
    ...
    \vspace{0.3cm}                                                  % En este apartado coloca tu nombre. Recuerda que debe estar en mayúsculas.
    {\large TU NOMBRE \\ TU NÚMERO DE CUENTA \par}                  % Es opcional colocar tu número de cuenta, es importante cuidar tus datos
